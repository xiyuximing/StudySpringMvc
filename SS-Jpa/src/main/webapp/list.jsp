                ...
                <form class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input name="address" type="text" class="form-control" id="address_update_static"
                                   placeholder="address">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input name="name" type="text" class="form-control" id="name_update_static"
                                   placeholder="name">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">电话</label>
                        <div class="col-sm-10">
                            <input name="phone" type="text" class="form-control" id="phone_update_static"
                                   placeholder="phone">
